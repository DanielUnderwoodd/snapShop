...
import { add_newAddress } from "../../actions/customer/customerAuthAction";
import "../../componentsCss/mapConfirm.css";
...
class MapConfirm extends Component {
  ...
  addAddress = async () => {
    ...
    const result = await this.props.add_newAddress(newAddress);
    if (!result.error) {
      this.props.onHide();
      ...
      return (
        <div>
          <Row>
            ...
            <Col
              onMouseLeave={this.hideBackBtn}
              onMouseEnter={this.showBackBtn}>
